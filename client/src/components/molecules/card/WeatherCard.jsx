            ...
            {weatherData && (
                <div className='weatherCard-content'>
                    <Card className='cardTrans'>
                        ...
                        <h1>{Math.round(weatherData.current.temp_c + 6)}°</h1>
                        ...
                        {weatherData.forecast && weatherData.forecast.forecastday && (
                            <div>
                                ...
                                <div className='weatherCard-block'>
                                    <p><FaArrowDown /> {Math.round(weatherData.forecast.forecastday[0].day.mintemp_c + 6)}°C</p>
                                    <p><FaArrowUp /> {Math.round(weatherData.forecast.forecastday[0].day.maxtemp_c + 6)}°C</p>
                                </div>
